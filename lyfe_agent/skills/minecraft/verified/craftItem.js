/**
 * Craft specified item(s) in Minecraft.
 * 
 * @param {Object} bot - The Mineflayer bot instance. Assume the bot is already spawned in the world.
 * @param {string} name - The name of the item to craft.
 * @param {number} [count=1] - The number of times to craft the item. Defaults to 1.
 *
 * Example usage:
